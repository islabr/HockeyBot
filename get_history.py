...
def get_player_history(team, player_name):
  ...
  base_url = "https://statsapi.web.nhl.com/api/v1/people/" + str(player_id)
  
  season_2021 = base_url + "/stats?stats=statsSingleSeason&season=20202021"
  season_1920 = base_url + "/stats?stats=statsSingleSeason&season=20192020"
  season_1819 = base_url + "/stats?stats=statsSingleSeason&season=20182019"
  season_1718 = base_url + "/stats?stats=statsSingleSeason&season=20172018"
  season_1617 = base_url + "/stats?stats=statsSingleSeason&season=20162017"
  season_1516 = base_url + "/stats?stats=statsSingleSeason&season=20152016"
  ...
  generate_graph(season, goals, assists, shots, points, player_name)
  return
...
def generate_graph(season, goals, assists, shots, points, player):
  ...
  fig.savefig('player_history.png')
  return