...
def format_skater_stats(json_data, name):
  ...
  try:
    ...
    return 'Could not retrieve stats for "%s"' % str(name[0])
  return stats
...
def get_player_stats(team, player_name):
  ...
  url = "https://statsapi.web.nhl.com/api/v1/people/" + str(player_id) + "/stats?stats=statsSingleSeason&season=20212022"
